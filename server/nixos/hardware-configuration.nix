...

{
    ...
    fileSystems."/" =
    { device = "/dev/disk/by-uuid/e67bdf62-c72a-4483-ab97-adcce5ccd763";
        fsType = "ext4";
    };

    fileSystems."/boot" =
    { 
        device = "/dev/disk/by-uuid/9622-F1CB";
        fsType = "vfat";
    };
    ...
    # systemd-networkd it's still possible to use this option, but it's recommended to 
    # use it in conjunction with explicit per-interface declarations with
